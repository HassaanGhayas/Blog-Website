export default function About() {
  return (
    <section className="my-[140px] mx-10 lg:mx-0">
      <div className="flex items-center justify-center flex-col gap-10  ">
        ...
        <div className="max-w-[800px] w-full min-w-[250px] text-sm sm:text-md xl:text-lg ">
          ...
          <br />
          <p>
            From caring for your favorite plants to uncovering the symbolism
            behind each petal, we cover everything you need to bring more floral
            joy into your life. Our mission is simple: to make the world a more
            beautiful place, one flower at a time.
          </p>
          <br />
          <p>
          ...
          <ul>
            <li>
              - Gardening Tips & Tricks: Easy-to-follow advice to help your
              garden bloom beautifully.
            </li>
            <li>
              - Flower Guides: Discover the stories and meanings behind popular
              flowers.
            </li>
            <li>
              - DIY Inspiration: Creative ways to use flowers in your everyday
              life.
            </li>
            <li>
              - Seasonal Highlights: Stay up-to-date on the best blooms for
              every season.
            </li>
          </ul>
          <br />
