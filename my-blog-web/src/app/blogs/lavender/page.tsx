      ...
      <div className="flex items-center justify-center flex-col gap-10  mx-10 lg:mx-0">
        ...
        <div className="max-w-[800px] w-full min-w-[250px] text-sm sm:text-md xl:text-lg ">
          <p>
            ...
            beloved plant in homes, gardens, and wellness spaces.
          </p>
          <br />
          <p>
            ...
            oils, the scent of lavender has a natural sedative effect on the
            nervous system, helping to promote relaxation and restful sleep.
          </p>
          <br />
          <p>
            ...
            essential oil is also a common ingredient in products like bath
            salts and pillow sprays, turning everyday routines into moments of
            relaxation.
          </p>
          <br />
          <p>
          ...
          <br />
          <p>
            In herbal medicine, lavender is prized for its antiseptic and
            anti-inflammatory properties. Lavender oil can be applied topically
            to soothe skin irritations, insect bites, and minor burns. It also
            has antimicrobial properties, making it a natural remedy for cuts
            and wounds. The versatility of lavender in promoting both mental and
            physical well-being has solidified its reputation as a healing herb.
          </p>
          <br />
          <p>
            Lavender essential oil is one of the most popular oils used in
          ...
          <p>
            ...
            creating a peaceful sanctuary from the demands of daily life.
          </p>
          <br />
          <p>
            Lavender is not only prized for its fragrance but also for its
            beauty in the garden. Its soft purple flowers and silver-green
            foliage add a touch of elegance to any outdoor space. Lavender is a
            hardy perennial that thrives in sunny, dry conditions, making it a
            popular choice for Mediterranean-style gardens. It can be grown in
            garden beds, borders, or pots, and its long-lasting blooms attract
            pollinators such as bees and butterflies.
          </p>
          <br />
          <p>
            avender requires well-drained soil and plenty of sunlight to
            flourish. Once established, it is drought-tolerant and relatively
            low-maintenance, making it a great choice for beginner gardeners.
            The flowers can be harvested and dried, preserving their fragrance
            and beauty for use in sachets, potpourri, or homemade
            lavender-infused oils and teas.
          </p>
          <br />
          <p>
            Lavender, with its rich history, healing properties, and serene
            fragrance, is a timeless flower that continues to enchant and soothe
            people around the world. Its calming scent has the power to
